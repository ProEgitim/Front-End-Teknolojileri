        ...
        <div class="card card-body mb-3">
                ...
                <div class="mb-2 card-body">
                    <div class="row">
                        <div class="col-md-2">
                        <span></span> 
                        <a href="#" target = "_blank" id = "${repo.name}"></a>
                        </div>
                        <div class="col-md-6">
                            <button class="btn btn-secondary">
                                Starlar  <span class="badge badge-light" id="${repo.stargazers_count}"></span>
                            </button>

                            <button class="btn btn-info">
                                Forklar  <span class="badge badge-light" id ="${repo.forks}"></span>
                            </button>
