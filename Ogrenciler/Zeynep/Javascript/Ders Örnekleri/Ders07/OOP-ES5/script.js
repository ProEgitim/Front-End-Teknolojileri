...
//   }
// }
// const emp = new Employee("Varol",30,4250);
// emp.showInfo();
// console.log(emp);
...
function Employee2(name,age,salary){
  ...
  this.salary = salary;
  // this.showInfo = function(){console.log("İsim: " + this.name + ", Yaş: " + this.age);}
  this.merhaba = function (){console.log("ÖERHABA!")}
  this.toString = function(){console.log("Bu Employee2 Objesidir.")}
}
Employee2.prototype.showInfo = function(){console.log("İsim: " + this.name + ", Yaş: " + this.age);}

const emp1 = new Employee2("Varol",35,4250);
// const emp2 = new Employee2("Sercan",25,5000);
